...
import youdu.com.databinding.FragmentBeatBoxBinding;
import youdu.com.databinding.ListItemSoundBinding;
...
public class BeatBoxFragment extends Fragment {
    ...
    private class SoundHolder extends RecyclerView.ViewHolder {
        private ListItemSoundBinding mItemBinding;

        public SoundHolder(ListItemSoundBinding binding) {
            super(binding.getRoot());
            mItemBinding = binding;
            mItemBinding.setViewModel(new SoundViewModel(mBeatBox));
        }

        public void bind(Sound sound) {
            mItemBinding.getViewModel().setSound(sound);
